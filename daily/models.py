...
class Daily_Informations(models.Model):
    ...
    price = models.CharField(max_length=500, blank=True, null=True, verbose_name='قیمت واحد')
    weight = models.FloatField(max_length=500, blank=True, null=True, verbose_name='وزن')
    total = models.CharField(max_length=500, blank=True, null=True, verbose_name='جمع کل')
    descriptions = models.TextField(null=False, blank=True, default=' ثبت نشده', max_length=200, verbose_name='توضیحات')
